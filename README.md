...
| **[Murf](https://murf.ai/)** | AI voice generator for text-to-speech voiceovers. | ❌ | ❌ | 🌍 Web App, 🔌 API | [Oct 2020](https://www.producthunt.com/products/murf-ai/launches) |
| **[NaturalReader](https://www.naturalreaders.com/)** | Text-to-speech platform with AI voices. | ❌ | ❌ | 🌍 Web App, 📊 Desktop App | [Jan 2018](https://www.producthunt.com/products/natural-reader/launches) |
...
| Project | Description | Open-Source | GitHub | Type | Released |
|---------|-------------|-------------|--------|------|----------|
| **[Data Formulator](https://github.com/microsoft/data-formulator)** (by Microsoft) | Tool for creating data visualizations with AI agents. | ✅ | [microsoft/data-formulator](https://github.com/microsoft/data-formulator) (⭐️ ~14.4k) | 🌍 Web App | [Jun 2024](https://github.com/microsoft/data-formulator/releases) |
...
| Project | Description | Open-Source | GitHub | Type | Released |
|---------|-------------|-------------|--------|------|----------|
| **[Fellou](https://fellou.ai/)** | Browser with autonomous task automation and workflows. | ✅ | [FellouAI/eko](https://github.com/FellouAI/eko) (⭐️ ~4.8k) | 📊 Desktop App | [May 2025](https://fellou.ai/blog/post/fellou-v2-launch/) |
